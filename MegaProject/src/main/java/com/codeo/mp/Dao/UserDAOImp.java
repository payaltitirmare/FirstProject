...
public class UserDAOImp implements UserDAO {
	...
	private static final String DELETE_USER ="delete from user_registration where userid= ?;";
	private static final String EDIT_USER = "select userid, user_name, user_mobno, user_adderess, user_emailid, user_pass from user_registration where userid=?";
	private static  final String UPDATE_USERS_SQL = "update user_registration set user_name = ?,user_mobno= ?, user_adderess =?,user_emailid =?,user_pass =? where userid = ?;";

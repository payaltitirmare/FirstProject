...
<%@include file="Navbar.jsp" %>
  ...
  <div class="mb-3"> 
             <a href="Adding_Category.jsp" class="btn btn-raised gradient-crystal-clear white"><i class="fa fa-plus " aria-hidden="true"></i> Add Category </a> 
                ...
                <div class="card-body">
                    <div class="card-block">
                        ...
                        <table class="table table-responsive-md text-center " >
                          ...
                          <td><a  href="DeleteCategory.jsp?id=<%=resultset.getString(1) %>"><i class="ft-trash font-medium-3 red"></i></a></td>
                          
                               <!--   <td> <a  href="EditCategory.jsp?id=<%=resultset.getString(1) %>"><i class="ft-edit orange"></i></a> </td> -->
                                 <td> <a  href="Addcategory?id=<%=resultset.getString(1) %>"><i class="ft-edit orange"></i></a> </td>
